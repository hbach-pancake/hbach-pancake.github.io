...
export class FlyingEnemy extends Enemy{
    constructor(game){
        ...
        this.width = 60 
        this.height = 44
        this.x = this.game.width + Math.random() * 0.5 * this.game.width
...
export class GhostEnemy extends Enemy{
    constructor(game){
        ...
        this.width = 60 
        this.height = 44
        this.x = this.game.width + Math.random() * 0.1 * this.game.width
        this.y = Math.random() * this.game.height * 0.4
        this.speedX = Math.random() + 1
        this.speedY = 0
        this.maxFrame = 5
        this.image = document.getElementById('enemy_gosh')
        this.angles = 0
        this.vas = Math.random() * 0.1 + 0.1
    }
    update(deltaTime){
        super.update(deltaTime)
        this.angles += this.vas
